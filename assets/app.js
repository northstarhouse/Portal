(() => {
  ...
  function QuarterlyView({ navigateOp, quarterlyArea, navigateToQuarterly }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { maxWidth: "100%" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginBottom: 20 } }, /* @__PURE__ */ React.createElement("div", { style: { background: "#faf8f5", border: "0.5px solid #e8e0d5", borderRadius: 10, padding: "16px 20px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, textTransform: "uppercase", letterSpacing: 1.2, color: gold, fontWeight: 600, marginBottom: 8 } }, "About Quarterly Updates"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: "#555", lineHeight: 1.7, fontStyle: "italic" } }, "Share quarterly progress, challenges, and support needs for each focus area."), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 10, display: "flex", flexDirection: "column", gap: 6 } }, [["1", "Area lead submits this form"], ["2", "Co-Champions review submissions"], ["3", "Discussed as main item on Board agenda"]].map(function(s) {
    ...
    }))), /* @__PURE__ */ React.createElement("div", { style: { background: "#faf8f5", border: "0.5px solid #e8e0d5", borderRadius: 10, padding: "16px 20px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, textTransform: "uppercase", letterSpacing: 1.2, color: gold, fontWeight: 600, marginBottom: 10 } }, "Quarterly Schedule"), [
      ...
      return /* @__PURE__ */ React.createElement("div", { key: q.q, style: { marginBottom: 10, paddingBottom: 10, borderBottom: "0.5px solid #ede5d8", opacity: isCurrent ? 1 : 0.55 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 3 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, fontWeight: 700, color: isCurrent ? gold : "#888" } }, q.q), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#aaa" } }, q.dates), isCurrent && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, background: gold, color: "#fff", borderRadius: 20, padding: "1px 7px", fontWeight: 600 } }, "Current")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#777", lineHeight: 1.8, paddingLeft: 2 } }, /* @__PURE__ */ React.createElement("span", { style: { color: "#999" } }, "Due:"), " ", q.due, " \xA0\xB7\xA0 ", /* @__PURE__ */ React.createElement("span", { style: { color: "#999" } }, "Co-Champions:"), " ", q.champion, " \xA0\xB7\xA0 ", /* @__PURE__ */ React.createElement("span", { style: { color: "#999" } }, "Board:"), " ", q.board));
  ...
  function OperationalView({ opArea, navigateToQuarterly }) {
    ...
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 12, padding: "14px 20px", border: "0.5px solid #e8e0d5", marginBottom: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: 16, marginBottom: 20 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, textTransform: "uppercase", letterSpacing: 1.2, color: "#888", fontWeight: 600, marginBottom: 6 } }, "Operational Area"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 22, fontWeight: 700, color: "#2a2a2a", fontFamily: "'Cardo', serif" } }, area)), /* @__PURE__ */ React.createElement("div", { style: { width: 200, flexShrink: 0 } }, (function() {
      ...
      var backCard = /* @__PURE__ */ React.createElement("div", { style: { backfaceVisibility: "hidden", WebkitBackfaceVisibility: "hidden", transform: "rotateY(180deg)", background: "#fff", borderRadius: 12, padding: "18px 24px", border: "0.5px solid #e8e0d5", position: "absolute", top: 0, left: 0, right: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, textTransform: "uppercase", letterSpacing: 1.2, color: gold, fontWeight: 600 } }, cq, " ", (/* @__PURE__ */ new Date()).getFullYear(), " Reflection"), /* @__PURE__ */ React.createElement("button", { onClick: function(e) {
        ...
        var sc = st && stColors[st] ? stColors[st] : null;
        return /* @__PURE__ */ React.createElement("div", { key: i, style: { background: sc ? sc.bg : "#faf8f5", borderRadius: 8, padding: "8px 12px", border: "0.5px solid " + (sc ? sc.color + "33" : "#e8e0d5") } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "flex-start", gap: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#999", marginBottom: 2 } }, "Goal ", i + 1, " \u2014 ", /* @__PURE__ */ React.createElement("span", { style: { color: "#555" } }, g)), sm && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#555", lineHeight: 1.5 } }, sm)), sc && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, fontWeight: 600, padding: "1px 7px", borderRadius: 20, background: "#fff", color: sc.color, flexShrink: 0 } }, st)));
  ...
  function Dashboard() {
    ...
    })))), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column" } }, /* @__PURE__ */ React.createElement("div", { style: { background: "#fdfcfb", padding: "24px 32px 18px", borderBottom: "3px solid rgba(136,108,68,0.35)", position: "sticky", top: 0, zIndex: 10 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 14 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 38, height: 38, borderRadius: 9, background: "rgba(136,108,68,0.1)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 } }, /* @__PURE__ */ React.createElement(NavIcon, { id: active, active: true })), /* @__PURE__ */ React.createElement("h1", { style: { margin: 0, fontSize: 26, fontWeight: 700, color: gold, fontFamily: "'Cardo', serif", textShadow: "1px 2px 0px rgba(136,108,68,0.2)" } }, mod && mod.label), active === "operational" && opArea && /* @__PURE__ */ React.createElement("button", { onClick: function() {
      setQuarterlyArea(opArea);
      setActive("quarterly");
    }, style: { marginLeft: "auto", background: "transparent", color: gold, border: "1.5px solid " + gold, borderRadius: 9, padding: "9px 20px", fontSize: 13, fontWeight: 600, cursor: "pointer", whiteSpace: "nowrap" } }, "Submit Quarterly Update"))), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, padding: "28px 32px" } }, /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 900 } }, /* @__PURE__ */ React.createElement(View, { navigate: setActive, opArea, navigateOp: function(a) {
      setOpArea(a);
      setActive("operational");
