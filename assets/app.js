(() => {
  ...
  var AREA_DEFAULTS = {
    "Construction": { lead: "Rick Panos", budget: 12e3, icon: '<path d="m15 12-8.5 8.5c-.83.83-2.17.83-3 0 0 0 0 0 0 0a2.12 2.12 0 0 1 0-3L12 9"/><path d="M17.64 15 22 10.64"/><path d="m20.91 11.7-1.25-1.25c-.6-.6-.93-1.4-.93-2.25v-.86L16.01 4.6a5.56 5.56 0 0 0-3.94-1.64H9l.92.82A6.18 6.18 0 0 1 12 8.4v1.56l2 2h2.47l2.26 1.91"/>' },
    "Grounds": { lead: "Paula Campbell", budget: 14e3, icon: '<path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10z"/><path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12"/>' },
    "Interiors": { lead: "Rebeka Freeman", budget: 2500, icon: '<path d="M8 22h8l2-10H6z"/><path d="M6 12h12"/><line x1="12" y1="12" x2="12" y2="7"/><path d="M9.5 5c0-2.5 5-2.5 5 0 0 1.5-1.5 3-2.5 3.5C11 8 9.5 6.5 9.5 5z"/><path d="M8 7c-.5-2 1-4 3-4"/><path d="M16 7c.5-2-1-4-3-4"/>' },
    ...
    "Events": { lead: "Barb Kusha", budget: 7500, icon: '<rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><line x1="8" y1="14" x2="8" y2="14"/><line x1="12" y1="14" x2="12" y2="14"/><line x1="16" y1="14" x2="16" y2="14"/>' },
    "Marketing": { lead: "Haley Wright", budget: 1e3, icon: '<path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/><path d="M3.22 12H9.5l1.5-3 2 6 1.5-3h5.27"/>' },
    "Venue": { lead: "Staff", budget: null, icon: '<path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>' }
  };
  function Dashboard() {
